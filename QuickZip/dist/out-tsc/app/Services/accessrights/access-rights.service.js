...
/// <reference path="../../../models/accessrights/access-rights-details.ts" />
...
var AccessRightsService = /** @class */ (function () {
    ...
    AccessRightsService.prototype.getInsertdata = function (userid, storeIsActive, storeIsRead, storeLinkID) {
        alert('service');
        return this._http.get(this.baseUrl + 'api/AccessRights/getInsertdata/' + userid + '/' + storeIsActive + '/' + storeIsRead + '/' + storeLinkID);
    };
