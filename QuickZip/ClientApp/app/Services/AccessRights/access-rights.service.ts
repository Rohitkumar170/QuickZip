...
export class AccessRightsService {
    ...
    getInsertdata(userid, storeIsActive, storeIsRead, storeLinkID): Observable<any> {
       // alert('service')
        return this._http.get<any>(this.baseUrl + 'api/AccessRights/getInsertdata/' + userid + '/' + storeIsActive + '/' + storeIsRead + '/' + storeLinkID);
    }
}
